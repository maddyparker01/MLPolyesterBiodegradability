from featurisation.feature_transformers import get_data, getFP_WithPred
...
pred = best_model.predict_proba(mols_new)

# START MODEL ----------------------------------------------------
# define the model
pipeline = Pipeline([
    ('fingerprint', getFP_WithPred()),
...
model_filename = '../models/chain_step2.joblib'
